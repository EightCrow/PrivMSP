...
def check_directories(args):
  ...
  # 创建隐私微调模型保存目录
  if args.task == 'privacy_tune' and args.privacy_model_save_dir:
    os.makedirs(args.privacy_model_save_dir, exist_ok=True)
    print(f"Created {args.privacy_model_save_dir} for privacy tuned models")
  ...
  if args.dataset == 'topv2' and args.do_train and args.task not in ['synthesize', 'classify', 'privacy_tune']:
  ...
  # 创建可视化目录
  if args.visualize_distribution and args.visualization_dir:
    os.makedirs(args.visualization_dir, exist_ok=True)
    print(f"Created {args.visualization_dir} for distribution visualizations")
