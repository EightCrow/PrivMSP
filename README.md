...
本项目实现了"Mixture of Soft Prompts for Controllable Data Generation"（MSP，软提示混合用于可控数据生成）方法，该方法于2023年被EMNLP接收。MSP是一种参数高效的程序，用于以可控方式生成多属性数据，并应用去噪机制来提高合成数据的质量。
...
3. **MAUVE评分**：使用MAUVE评分衡量指令之间的差异，提供更全面的评估指标。
